...
def main():
    ...
    annoying_tick_callback = tornado.ioloop.PeriodicCallback(
        ats.send_annoying_tick, 5000, io_loop=tornado.ioloop.IOLoop.instance())
    system_set_callback = tornado.ioloop.PeriodicCallback(
        system_set.process, 100, io_loop=tornado.ioloop.IOLoop.instance())

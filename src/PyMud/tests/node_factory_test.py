...
class Test(unittest.TestCase):
    ...
    def testCreateNodesTwoComponents(self):
        node_list = self.node_factory.create_node_list(["test_component0", "test_component1"])
        #We got the right number of nodes
    ...
    def test_optional_component(self):
        node_list = self.node_factory.create_node_list(["test_component1", "test_component3"], optional=["test_component2"])
        #We got the right number of nodes
        #Only 1 and 5 should pass
        self.assertEqual(len(node_list), 3)
    ...
    def testOptional(self):
        names = self.node_factory.create_node_list(["test_component2"], optional=["test_component1"])
        print(names)

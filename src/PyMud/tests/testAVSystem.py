...
class NetworkAVTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.player1 = NetworkAVNode("1", Location("1", "0",  0, 0, 0), Senses("1"), AVMessages("1"))
        #different room, same location
        self.player2 = NetworkAVNode("2", Location("2", "1",  0, 0, 0), Senses("2"), AVMessages("1"))
        #same room, too far away
        self.player3 = NetworkAVNode("3", Location("3", "0",  100, 100, 100), Senses("3"), AVMessages("1"))
        #same room, too far away
        self.player4 = NetworkAVNode("4", Location("4", "0",  15, 15, 15), Senses("4"), AVMessages("1"))

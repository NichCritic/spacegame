...
class AnnoyingTickSystemTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        object_db = DBComponentSource(all_db, self.Session)
    ...
    def testTwoItems(self):
        ...
        self.assertEqual(self.od.describe(data).realize(), "the wooden foo and the crystal bar")
    ...
    def testThreeItems(self):
        ...
        self.assertEqual(self.od.describe(data).realize(), "the wooden foo and bar and the crystal baz")
